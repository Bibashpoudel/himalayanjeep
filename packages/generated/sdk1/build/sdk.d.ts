...
export declare const sdk: {
    ...
    processItemAssets: <KInterfaceName extends keyof import("sdk-db").DbModels>(item: import("model-types").AugmentedAnyModelType, interfaceName: KInterfaceName, operationName: string | null, customQueryConfig: import("fs-orm").CustomQueryConfig) => Promise<import("model-types").AugmentedAnyModelType>;
    ...
    getMergedQueryConfig: (modelName: keyof import("sdk-db").DbModels, customQueryConfig?: import("fs-orm").CustomQueryConfig | undefined) => import("fs-orm").MergedQueryConfig;
    randomName: () => string;
    ...
    getDbModelNames: (config?: {
        bundleId?: string | undefined;
    } | undefined) => Promise<(keyof import("sdk-db").DbModels)[]>;
    getDbModel: <KInterface_1 extends keyof import("sdk-db").DbModels>(interfaceName: KInterface_1, config?: import("db-recipes").GetDbModelConfig | undefined) => Promise<import("db-recipes").GetDbModelResult<KInterface_1>>;
    ...
    getReferencableModelData: (dbModelName: keyof import("sdk-db").DbModels) => Promise<{
        id: string;
        name: any;
        slug: any;
    ...
    upsertDbModel: <KInterfaceName_1 extends keyof import("sdk-db").DbModels, KItem extends import("sdk-db").DbModels[KInterfaceName_1]>(interfaceName: KInterfaceName_1, data: KItem | KItem[], isNew?: boolean | undefined) => Promise<import("fs-orm").DbQueryResult>;
    ...
    executeFunctionWithParameters: (functionName: "driverLogin" | "driverSignup" | "getMyJeep" | "getPublicJeeps" | "updateMyProfile" | "allOperationsRemoveJsSrc" | "allOperationsToMarkdown" | "clearAllTsDatabases" | "codeAll" | "forAllFiles" | "forAllFolders" | "getAllOperationClassifications" | "gitShipAllRepos" | "mdAllOperations" | "minifyAllOperations" | "publishAllOperations" | "removeAllFiles" | "removeAllFolders" | "removeAll" | "renameAll" | "runScriptEverywhere" | "setScriptEverywhere" | "askOk" | "ask" | "getArgumentOrAsk" | "compressAsset" | "convertToMp3" | "deleteReferencedAsset" | "downloadRemoteAsset" | "findAbsoluteAssetPathFromReference" | "findAllProjectMedia" | "findAssetParametersRecursively" | "getAssetDirectlyGetApi" | "getReferencedAssetGetApi" | "getStorageLocationInfo" | "getTemporaryAssetsFolderPath" | "processAsset" | "processItemAssets" | "removeOldTemporaryAssets" | "serverDownloadReply" | "uploadAssetPostApi" | "getAugmentedWordObject" | "getAugmentedWords" | "getBundleAugmentedWords" | "getBundleSummary" | "getDbModelsForBundle" | "cleanupTsDatabase" | "shouldDeleteTsModel" | "csvItemArrayToCsvString" | "tryParseCsv" | "generateCsvInstance" | "generateJsonSingleInstance" | "generateKvmdInstance" | "generateMarkdownInstance" | "generateSlugTestModel" | "getMergedQueryConfig" | "randomName" | "runModelEndToEndTest" | "testOperationModels" | "cacheLookup" | "calculateOperatingSystemBundle" | "deleteDbModel" | "getDatabaseMenu" | "getDbModelNames" | "getDbModel" | "getFunctionIndex" | "getNestedDatabaseMenu" | "getReferencableModelData" | "hasDbRecipes" | "makeSrcRelativeFolder" | "tsInterfaceToDbMenu" | "upsertDbModel" | "validateInput" | "filterInterfacesFromOperationNames" | "getDbModelsFromOperations" | "findAllDependencyOperations" | "findDependantsRecursively" | "findDependants" | "findDependenciesRecursively" | "findMonorepoModules" | "getDependencyObject" | "getDependencyTree" | "folderGetUpdatedAt" | "addDefaultValues" | "alterAny" | "alterCsv" | "alterJsonMultiple" | "alterJsonSingle" | "alterKeyValueMarkdown" | "alterMarkdown" | "augmentItemWithReferencedDataRecursively" | "calculateOperationsObject" | "createDb" | "findParent" | "getAugmentedData" | "getDatabaseFiles" | "getDatabaseRootFolder" | "getDbFileLocation" | "getDbStorageMethodExtension" | "getDefaultLocationPattern" | "getItemModelLocation" | "getLength" | "getLocationPattern" | "getMergedConfigOperationPath" | "getParentSlug" | "getRootFolders" | "getWildcardDbFileLocations__OLD" | "getWildcardDbFileLocations" | "groupByFile" | "makeStoringItem" | "mergeConfigs" | "removeKeyValueMarkdown" | "removeMultiple" | "upsertItems" | "upsertKeyValueMarkdown" | "upsert" | "getExtension" | "getFolderJs" | "getSubExtension" | "isPathRelative" | "removeTrailingSlash" | "withoutExtension" | "calculateDeviceName" | "cleanupTimer" | "executeFunctionWithParameters" | "getHasAuthorization" | "getNewPerformance" | "getTsFunction" | "storeFunctionExecution" | "upsertDevice" | "generateNamedIndex" | "generateSimpleIndex" | "isTestFn" | "mapToImportStatement" | "generateDbSdk" | "generateEnvSdks" | "generateFunctionPathsSdk" | "generateFunctionSdks" | "generateOperationsSdk" | "generateSdkOperations" | "getSdkDescription" | "getSdkFunctions" | "isTsFunctionIndexable" | "newEnvSdk" | "newSdkKeysOperation" | "newSdkOperation" | "tsFunctionIsSdkable" | "getAllOperationSourcePaths" | "getImportedDependencies" | "getPackage" | "isAbsoluteImport" | "calculatePackageJsonDependencies" | "findAndWriteImportsExports" | "getDefaultSymbolType" | "getExportSpecifierNames" | "getExportSymbolTypeRecursive" | "getImportSpecifiersWithNames" | "getImportsExports" | "getPackageNameFromAbsoluteImport" | "getSymbolTypeDeclarations" | "getTypeFromImportSpecifierRecursive" | "isAbsoluteImportBuiltin" | "isImportFromOptionalFile" | "writeResult" | "getOperationBins" | "getOperationPackageName" | "getPackageJson" | "getPackageSourcePaths" | "findAndUpsertTsInterfaces" | "findCommentTypes" | "generateSchema" | "getAllComments" | "getDbStorageMethod" | "getFrontmatterDbStorageMethod" | "getFrontmatterFunctionParameters" | "getIndexId" | "getMaxIndentationDepth" | "getMinMaxValidation" | "getNumberOfLines" | "getParamSchema" | "getParametersFromInterfaces" | "getPossibleRefs" | "getSizeSummary" | "getSpecialExtensionDbStorageMethod" | "getTsStatements" | "getTypeInfo" | "getValidatedOperationPathParse" | "hasDefinition" | "indexTypescriptFile" | "indexTypescript" | "isPrimitive" | "makeTsComment" | "schemaToTsInterface" | "tryCreateSchema" | "typeToSchema" | "dev" | "determineFileType" | "exploreGitRepoFolders" | "exploreMultiple" | "exploreOperationFolders" | "explorePreset" | "explore" | "findAllDocsFolderPaths" | "findAllDotGitFolders" | "findAllFoldersWithName" | "findAllPackages" | "findAllTodoFolderPaths" | "pathArrayIsOperation" | "runTestsForOperation" | "runTests" | "preIndexLint" | "sendMail" | "bundleFolderWithMarkdown" | "bundleToBookMarkdown" | "bundleToMarkdown" | "deployToVercel" | "emailMarkdownParse" | "generateStaticSite" | "getJsonSchemaSummary" | "getMergedMarkdownOutlineUrl" | "getOutline" | "getTitlesRecursively" | "getTypeDescriptorRecursive" | "isUpperCase" | "makeOutlineMarkdownString" | "makePropertiesTable" | "markdownChunkToMarkdownStringRecursive" | "markdownChunksToMarkdownStringRecursive" | "markdownToSayable" | "mdToPdf" | "mergeMarkdownParse" | "noNewlines" | "operationRadio" | "operationToMarkdown" | "printNestedTitles" | "print" | "projectToMarkdown" | "propertyToTableRow" | "sayablesToMp3" | "selectRandomOperation" | "simplifiedSchemaToMarkdownString" | "tsFunctionToMarkdownString" | "tsInterfaceToMarkdownString" | "tsVariableToMarkdownString" | "upMarkdownChunkLevelRecursively" | "copyStaticAssets" | "getAllMarkdownReaderPages" | "getFolderExplorationInfo" | "getMarkdownModelPages" | "getMarkdownPageInfo" | "getMarkdownReaderPages" | "getMarkdownReaderQueryPaths" | "getOperationPages" | "getPublicMarkdownFilePaths" | "getTodoPages" | "markdownReaderGetStaticPaths" | "markdownReaderGetStaticProps" | "removeExtensionsFromPath" | "removeNumberPrefix" | "shouldExposeMarkdownFile" | "minifyBuild" | "getAvailableOperationName" | "getOperationConfig" | "newOperationWithFiles" | "newOperation" | "newTemplate" | "nodemon" | "addPeerMessage" | "addPeer" | "getAllAppOperations" | "getFirstEmoji" | "getNestedPathObject" | "getPeerMessages" | "getPeersFromPeersRecursively" | "getPeers" | "getPublicFolderNestedPathObjectFromPeer" | "getPublicFolderNestedPathObject" | "getPublicPeers" | "isPortUsed" | "lateFetchPeerMessageSync" | "ping" | "proactivePushAddPeerMessage" | "removePeer" | "updatePeer" | "getPrimaryPersona" | "readCsvFileSync" | "readCsvFile" | "readJsonFileSync" | "readJsonFile" | "readKvmdFile" | "readMarkdownFileToModel" | "readMarkdownFile" | "clearTsDatabase" | "executeCommandQuietUnlessFail" | "exitIfProcessDependenciesChanged" | "generateJsonSchemas" | "getAllDbModels" | "getFileIds" | "getIndexFileIds" | "getSrcIds" | "isOperationBuildNeeded" | "isSdkOperation" | "rebuildAllOperations" | "rebuildOperation" | "shouldSkip" | "yarnBuild" | "isEqualArray" | "renameTemplateFiles" | "renameTemplateToNormalFile" | "renameToTemplateFile" | "addAuthenticationMethod" | "addDeviceAuthenticatedMethod" | "addDeviceAuthenticationMethodConfirm" | "addPersonAuthenticationMethod" | "comparePassword" | "encryptPassword" | "isPhoneNumber" | "isValidPassword" | "login" | "logoutPostApi" | "removeDeviceAuthenticationMethod" | "removePersonAuthenticationMethod" | "signup" | "setJsonKey" | "setKeyAtLocation" | "sendSms" | "getAllTsMorphSourceFiles" | "getHasGeneric" | "getTsMorphProject" | "initiateWatch" | "makeSubscription" | "pickWatcher" | "watchFoldersChokidar" | "watchFoldersFs" | "watchFolders" | "exitIfOperationsChange" | "gitCommitAllCron" | "watchOperations" | "writeToAssets", authToken: string | undefined, parameters: any[] | undefined, ctx: import("server/typings/common").Context) => Promise<import("api-types").RealApiReturnType<any>>;
